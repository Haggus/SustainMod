...
public class ContainerWindTurbine extends Container{
	...
	public ContainerWindTurbine(InventoryPlayer par1InventoryPlayer, TileEntityWindTurbine par2TileEntityFurnace)
	{
		this.windTurbine = par2TileEntityFurnace;
	...
	{
		return this.windTurbine.isUseableByPlayer(par1EntityPlayer);
	}
