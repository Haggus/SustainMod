...
public class TileEntityQuartzFurnace extends TileEntity implements ISidedInventory{
	...
	private static final int[] slots_top = new int[]{0};		//<< Which slots can be accessed from the top
	...
	public String getInvName() {
		return this.isInvNameLocalized() ? this.localizedName : "container.quartzFurnace";
	}
	...
	public static int getItemBurnTime(ItemStack itemstack) {
		if(itemstack == null) {
			...
			//Not a real recipe
			if(i == Item.netherQuartz.itemID) return 250;
