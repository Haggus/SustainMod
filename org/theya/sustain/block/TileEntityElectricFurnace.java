...
public class TileEntityElectricFurnace extends TileEntity implements ISidedInventory{
	...
	*/
	...
	{
    	return this.isInvNameLocalized() ? this.field_94130_e : "container.electricFurnace";
	}
	...
	public boolean isMacerating(){
		if(hasPower() && canSmelt() && this.cookTime > 0) {
			return true;
		} else {
			return false;
		}
	...
	public void updateEntity(){
    	...
    	if (!this.worldObj.isRemote){
        	...
        	BlockElectricFurnace.updateFurnaceBlockState(this.isMacerating(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
    	}
