...
public class TileEntityWaterTurbine extends TileEntity implements ISidedInventory{
	...
	private String waterTurbineName;
	...
	{
    	return this.isInvNameLocalized() ? this.waterTurbineName : "container.waterTurbine";
	}

	public boolean isInvNameLocalized()
	{
    	return this.waterTurbineName != null && this.waterTurbineName.length() > 0;
	}

	public void setGuiDisplayName(String par1Str)
	{
    	this.waterTurbineName = par1Str;
	}
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound)
	{
    	...
    	{
        	this.waterTurbineName = par1NBTTagCompound.getString("CustomName");
    	}
	}
	...
	public void writeToNBT(NBTTagCompound par1NBTTagCompound)
	{
    	...
    	{
        		par1NBTTagCompound.setString("CustomName", this.waterTurbineName);
    	}
	}
